...
urlpatterns = [
    ...
    path('admin/employees/search/', views.api_employee_name_search, name='api_employee_name_search'),
    path('admin/employees/has-account/', views.api_employee_has_account, name='api_employee_has_account'),
